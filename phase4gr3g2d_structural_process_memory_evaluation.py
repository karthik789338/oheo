...
OUTPUT_DIR = Path(
    "outputs/"
    "phase4gr3g2d_tier_c_v4_structural_process_memory"
)
...
def determine_alignment(
    ...
    require(
        ...
        == STATE_COUNT,
        (
            "G2D requires the frozen "
            "8-state OCM representation."
        ),
    )
    ...
    require(
        ...
        "No development observations for alignment.",
    )
    ...
    require(
        ...
        "Latent alignment is not bijective.",
    )

    unique_top1_count = len(
        set(
            int(
                np.argmax(
                    score_matrix[
...
def main() -> None:
    ...
    summary = {
        ...
        "phase4gr3g2d_status":
            "structural_process_memory_results_frozen",
